...
describe('FacebookAuthentication', () => {
  ...
  it('should call LoadFacebookUserSpy with correct params', async () => {
    await sut({ token })
  ...
  it('should throw AuthenticationError when LoadFacebookUserSpy returns undefined', async () => {
  ...
  it('should rethrow if SaveFacebookAccount throws', async () => {
    crypto.generate.mockRejectedValueOnce(new Error('crypto_error'))
