import { Validator, RequiredString, Required, RequiredBuffer, AllowedMimeTypes, MaxFileSize, Extension } from '@/application/validation'
...
export class ValidationBuilder {
  ...
  image ({ allowed, maxSizeInMb }: { allowed?: Extension[], maxSizeInMb: number}): ValidationBuilder {
    if (allowed !== undefined && this.value.mimeType !== undefined) {
